    ...
    <div className="flex flex-col gap-[22px] px-3 py-5 bg-[#1F1F1F]">
      ...
      <section className="flex justify-between px-5">
        <div className="flex flex-col gap-[5px] items-center">
          ...
          <p className="text-[#6F6F6F] font-normal text-[8px]">989K reviews</p>
        </div>
        ...
        <div className="flex flex-col gap-[5px] items-center">
          ...
          <p className="text-[#6F6F6F] font-normal text-[8px]">122 MB</p>
        </div>
        ...
        <div className="flex flex-col gap-[5px] items-center">
          ...
          <p className="text-[#6F6F6F] font-normal text-[8px]">Livre</p>
        </div>

        <div className="h-[20px] w-[1px] bg-[#5F5F5F]" />

        <div className="flex flex-col gap-[5px] items-center">
          <p className="text-[#C7C7C7] font-bold text-[8px]">10M+</p>

          <p className="text-[#6F6F6F] font-normal text-[8px]">Downloads</p>
        </div>
      </section>

      <div className="flex flex-col gap-4">
        <button className="font-semibold text-[10px] py-3 w-full rounded-full bg-[#A8C8FB] text-[#0A1F3E]">
          Instalar
        </button>
      ...
      <section className="px-2.5 flex flex-col gap-4">
        <header className="flex justify-between items-center w-full">
          <p className="font-semibold text-white text-xs">About this game</p>
        ...
        <p className="text-[10px] font-normal text-[#7E7E7E]">
          ROLL for riches, BUILD your empire, DREAM big & SCHEME your way to
          success!
        </p>
      </section>
